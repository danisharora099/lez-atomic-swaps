...
- Start RED from Gateway's proposed BIP-340/BIP-327 and exact-pinned
  swap-specific adaptor suite, pending Logos's GW-M3-001 disposition, plus the exact BIP-340 witness
