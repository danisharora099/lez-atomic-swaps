...
| F2 | LEZ–BTC via BIP-340 adaptor signatures and Taproot key-path cooperative claim | Gateway's proposed BIP-340/BIP-327 and exact-pinned swap-specific adaptor replacement suite; Logos disposition of GW-M3-001; both-direction Bitcoin Core testnet/regtest happy/refund/concurrency role E2E; cooperative claim decoded as key-path spend | Planned M3 |
