...
expected_elf_sha256="2eb04d0b0bbc4feb92f4d30f50a52f072c63ea98ffa9ce105856115b2e409d04"
expected_image_id="ab59719d5042426cb1328af7a740889a71134fad0309f9f500d084cd23392325"
...
rg -Fqx "idl_sha256 = \"${expected_idl_sha256}\"" "$artifact_manifest"
rg -Fqx "generated_client_sha256 = \"${expected_generated_client_sha256}\"" "$artifact_manifest"
rg -Fqx 'instruction_count = 18' "$artifact_manifest"
rg -Fqx 'initialize_token_witnessed_variant = 11' "$artifact_manifest"
rg -Fqx 'claim_token_witnessed_variant = 12' "$artifact_manifest"
